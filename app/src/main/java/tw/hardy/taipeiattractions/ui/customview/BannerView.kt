package tw.hardy.taipeiattractions.ui.customview
...
import tw.hardy.taipeiattractions.databinding.BannerImageItemBinding
...
class BannerView @JvmOverloads constructor(
    ...
    private var indicatorDrawableResId = R.drawable.bg_selector_banner_indicator
    ...
    private var autoplayInterval = 5000//ms
    ...
    @JvmOverloads
    fun <M> setData(
        dataList: List<M>, displayTextList: List<String>? = null,
        bind: (BannerImageItemBinding, M) -> Unit,
    ) {
        setData(dataList, displayTextList, BannerImageItemBinding::class, bind)
    }
